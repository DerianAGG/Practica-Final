...
public class Pasword extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText(" Taqueria El Miguel");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String Usuario="Jose Miguel";
        String Contraseña = "A";
        String passw=new String(jPasswordField1.getPassword());
        
        if(txtUsuario.getText().equals(Usuario)&&passw.equals(Contraseña)){
            Taqueria home=new Taqueria();
            home.setVisible(true);
        }else{
            JOptionPane.showMessageDialog(null, "Usuario y/o contraseña fallida");
        }
